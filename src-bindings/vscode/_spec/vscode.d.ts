...
declare module "vscode" {
   ...
   * error message.
   *
   * @see [show_information_message](#window.show_information_message)
   * @see [show_warning_message](#window.show_warning_message)
  ...
  export interface Terminal {
     ...
     *   	vscode.window.show_information_message(`Exit code: ${t.exitStatus.code}`);
     *   }
     * });
     * ```
     */
   ...
   * 	window.show_information_message('Hello World!');
   * });
   * ```
  ...
  export namespace window {
     ...
     */
    export function show_information_message(
      message: string,
      ...items: string[]
     ...
     * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
     */
    export function show_information_message<T extends MessageItem>(
      message: string,
      ...items: T[]
    ): Thenable<T | undefined>;
     ...
     * @return A thenable that resolves to the selected item or `undefined` when being dismissed.
     */
    export function show_warning_message<T extends MessageItem>(
      message: string,
      ...items: T[]
    ): Thenable<T | undefined>;
  ...
  interface Pseudoterminal {
     ...
     *   handleInput: data => {
     *     if (data !== 'y') {
     *       vscode.window.show_information_message('Something went wrong');
     *     }
     *     closeEmitter.fire();
     *   }
     * };
