...
declare module "vscode" {
  ...
  export type NotebookSelector =
    | NotebookFilter
    | string
    | ReadonlyArray<NotebookFilter | string>;
  ...
  export namespace notebook {
    export function createNotebookKernel(
      options: NotebookKernelOptions
    ): NotebookKernel2;
  }
  ...
  export namespace languages {
     ...
     * @return A [disposable](#Disposable) that unregisters this provider when being disposed.
     */
    export function registerInlineHintsProvider(
      selector: DocumentSelector,
  ...
  export namespace test {
     ...
     */
    export function publishTestResult(
  ...
  export class TestItem<TChildren = any> {
     ...
     */
    discoverChildren(
      progress: Progress<{ busy: boolean }>,
      token: CancellationToken
    ): void;
  }
  ...
  export namespace workspace {
    ...
    ): Thenable<WorkspaceTrustState | undefined>;
