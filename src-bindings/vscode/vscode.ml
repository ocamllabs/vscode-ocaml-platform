...
module TextEditorEdit = struct
  ...
  let replaceLocation_of_js js_val =
    ...
    else if Ojs.has_property js_val "start"
...
module ThemableDecorationInstanceRenderOptions = struct
  ...
  include
    [%js:
      ...
      val after : t -> ThemableDecorationAttachmentRenderOptions.t or_undefined [@@js.get]
...
module DecorationInstanceRenderOptions = struct
  ...
  include
    [%js:
      val light : t -> ThemableDecorationInstanceRenderOptions.t or_undefined [@@js.get]
      val dark : t -> ThemableDecorationInstanceRenderOptions.t or_undefined [@@js.get]
...
module DecorationOptions = struct
  ...
  let hoverMessage_of_js js_val =
    if Ojs.has_property js_val "value"
  ...
  include
    [%js:
      ...
      val renderOptions : t -> DecorationInstanceRenderOptions.t or_undefined [@@js.get]
...
module QuickPick = struct
  ...
  module Make (T : Ojs.T) = struct
    ...
    let set t ?activeItems ?busy ?buttons ?canSelectMany ?enabled
        ?ignoreFocusOut ?items ?keepScrollPosition ?matchOnDescription
        ?matchOnDetail ?placeholder ?selectedItems ?step ?title ?totalSteps
        ?value () =
...
module InputBoxOptions = struct
  ...
  include
    [%js:
      ...
      val ignoreFocusOut : t -> bool or_undefined [@@js.get]
      val validateInput : t -> (string -> string ProviderResult.t) or_undefined [@@js.get]
...
module MessageItem = struct
  ...
  include
    [%js:
      ...
      val create : title:string -> ?isCloseAffordance:bool -> unit -> t [@@js.builder]]
end
...
module Pseudoterminal = struct
  ...
  include
    [%js:
      ...
      val open_ : t -> ?initialDimensions:TerminalDimensions.t -> unit -> unit [@@js.call]
...
module Terminal = struct
  ...
  let creationOptions_of_js js_val =
    if Ojs.has_property js_val "pty"
...
module ExtensionContext = struct
  ...
  include
    [%js:
      ...
      val environmentVariableCollection : t -> EnvironmentVariableCollection.t [@@js.get]
...
module DocumentSelector = struct
  ...
  let t_of_js js_val =
    ...
    else if Ojs.has_property js_val "length"
...
module Task = struct
  ...
  let execution_of_js js_val =
    if Ojs.has_property js_val "process"
    then `ProcessExecution ([%js.to: ProcessExecution.t] js_val)
    else if Ojs.has_property js_val "command"
...
module ConfigurationScope = struct
  ...
  let t_of_js js_val =
    ...
    else if Ojs.has_property js_val "index"
    then `WorkspaceFolder ([%js.to: WorkspaceFolder.t] js_val)
...
module TreeItem = struct
  ...
  let label_of_js js_val =
    if Ojs.type_of js_val = "string"
    then `String ([%js.to: string] js_val)
    else if Ojs.has_property js_val "label"
  ...
  let tooltip_of_js js_val =
    ...
    then `Undefined
    else if Ojs.has_property js_val "value"
    then `MarkdownString ([%js.to: MarkdownString.t] js_val)
    else assert false
  ;;
...
module TreeDataProvider = struct
  ...
  module Make (T : Ojs.T) = struct
    ...
    include
      [%js:
        val onDidChangeTreeData : t -> T.t or_undefined Event.t or_undefined [@@js.get]
...
module TreeView = struct
  ...
  module Make (T : Ojs.T) = struct
    ...
    include
      [%js:
        val onDidExpandElement : t -> T.t TreeViewExpansionEvent.t Event.t [@@js.get]
        val onDidCollapseElement : t -> T.t TreeViewExpansionEvent.t Event.t [@@js.get]
        val selection : t -> T.t list [@@js.get]
...
module Window = struct
  include
    ...
    val createQuickPick :
      ((module Ojs.T with type t = 'a)[@js]) -> unit -> 'a QuickPick.t
