          ...
          if (typeof setting === "string") {
              ...
              <li key={setting}>
                <label>
                  <input
                    ...
                    onChange={({ target }) =>
                      onChange(update(parserSettings, setting, target.checked))
                    }
                  />
                  &nbsp;{setting}
                </label>
            ...
            return (
              <SettingsRenderer
                ...
                onChange={(settings) =>
                  onChange({ ...parserSettings, [setting.key]: settings })
                }
              />
            );
          }
...
SettingsRenderer.propTypes = {
  ...
  parserSettings: PropTypes.oneOfType([PropTypes.object, PropTypes.array])
    .isRequired,
