...
function make$3(env, root, discoveredManifestPath, t) {
  if (t) {
...
function ofName(n) {
  switch (n) {
    case "esy" :
        return /* Ok */Block.__(0, [/* Esy */1]);
    case "opam" :
        return /* Ok */Block.__(0, [/* Opam */0]);
    default:
      return /* Error */Block.__(1, ["Invalid name " + (String(n) + " was provided")]);
  }
}

function specOfName(env, name$2, root, discoveredManifestPath) {
  if (name$2 === name$1) {
    return make$2(env, root, discoveredManifestPath);
  } else if (name$2 === name) {
    return make$1(env, root, discoveredManifestPath);
...
function compare(x, y) {
  if (Caml_obj.caml_equal(x[0], y[0]) && Caml_obj.caml_equal(x[1], y[1])) {
    return 0;
  } else {
    return 1;
  }
...
var PackageManagerSpecTuple = {
  compare: compare
};

var PackageManagerSpecTupleSet = $$Set.Make(PackageManagerSpecTuple);
  ...
  return $$Node.Fs.readDir(Utils.Fpath.toString(projectRoot)).then((function (param) {
                if (param.tag) {
                  ...
                  return Promise.all(param[0].map((function (param) {
                                ...
                                return Promise.resolve(/* Ok */Block.__(0, [Curry._1(PackageManagerSpecTupleSet.of_list, Tablecloth.$$Array.toList(l.reduce((function (acc, x) {
                                                              return (
...
function init(env, folder) {
  ...
  return Utils.okThen((function (spec) {
                  return /* Ok */Block.__(0, [{
                            ...
                            if (param.tag) {
                              ...
                              if (packageManagersInUse) {
                                ...
                                return Utils.okThen((function (x) {
                                                var packageManagersInUse = Curry._1(PackageManagerSpecTupleSet.elements, x);
                                                if (packageManagersInUse) {
                    ...
                    var multipleChoices = Tablecloth.List.filter((function (param) {
                            var x = param[0];
                    ...
                    if (multipleChoices) {
                      if (multipleChoices[1]) {
                        ...
                        if (match == null) {
                          ...
                          return Vscode.window.showQuickPick(Tablecloth.$$Array.fromList(Tablecloth.List.map((function (param) {
                                                  if (param[0]) {
                                                    return "esy";
                                                  } else {
                                                    return "opam";
                                        ...
                                        if (packageManager == null) {
                                          return Promise.resolve(/* Error */Block.__(1, ["showQuickPick() returned undefined"]));
                                        } else {
                                          var pm = ofName(packageManager);
                                          if (pm.tag) {
                                            return Promise.resolve(/* Error */Block.__(1, [pm[0]]));
                                          } else {
                                            var pmx = pm[0];
                                            var match = Tablecloth.List.find((function (param) {
                                                    return Caml_obj.caml_equal(param[0], pmx);
                                                  }), multipleChoices);
                                            if (match !== undefined) {
                                              var match$1 = match;
                                              return make$3(env, match$1[1], projectRoot, match$1[0]);
                                            } else {
                                              return Promise.resolve(/* Error */Block.__(1, ["Weird invalid state: selected choice was not found in the list"]));
                                            }
                                          }
                                        }
                                      }));
                        } else if (match$1 == null) {
                          return specOfName(env, match, projectRoot, projectRoot);
                        } else {
                          return specOfName(env, match, match$1, projectRoot);
                        }
                      } else {
                        var match$2 = multipleChoices[0];
                        return make$3(env, match$2[1], projectRoot, match$2[0]);
                      }
                    } else {
