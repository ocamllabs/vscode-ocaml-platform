...
module Commands = struct
  ...
  let generate_sandbox_documentation = ocaml_prefixed "generate-sandbox-documentation"
  ...
  let open_ast_explorer_to_the_side = ocaml_prefixed "open-ast-explorer-to-the-side"
  ...
  let open_pp_editor_and_ast_explorer = ocaml_prefixed "open-pp-editor-and-ast-explorer"
  let open_ocamllsp_output = ocaml_prefixed "open-ocamllsp-output"
  let open_ocaml_platform_ext_output = ocaml_prefixed "open-ocaml-platform-ext-output"
