...
function stat(p) {
  return new Promise((function (resolve, param) {
                return Fs.stat(p, (function (err, stat) {
                              return resolve((err == null) ? /* Ok */Block.__(0, [stat]) : /* Error */Block.__(1, ["Couldn't stat"]));
                            }));
              }));
}
...
function readDir(path) {
  return new Promise((function (resolve, param) {
                return Fs.readdir(path, (function (error, files) {
                              if (error == null) {
                                return resolve(/* Ok */Block.__(0, [files]));
                              } else {
                                return resolve(/* Error */Block.__(1, [error.message]));
                              }
                            }));
              }));
}
