...
module Package = struct
  ...
  let name _t = failwith "Dune inspectionn is not supported yet."
  let version _t = failwith "Dune inspectionn is not supported yet."
  let documentation _t = failwith "Dune inspectionn is not supported yet."
  let synopsis _t = failwith "Dune inspectionn is not supported yet."
  let has_dependencies _t = failwith "Dune inspectionn is not supported yet."
  let dependencies _t = failwith "Dune inspectionn is not supported yet."
end
