...
class virtual ['res] lift2 =
  object (self)
    method virtual tuple : (string * ('res, string) result) list -> ('res, string) result
    ...
    method
      virtual constr
      : string -> (string * ('res, string) result) list -> ('res, string) result
    ...
    method
      virtual list
      : 'a.
        ('a -> 'a -> ('res, string) result) -> 'a list -> 'a list -> ('res, string) result
    ...
    method location_stack : location_stack -> location_stack -> ('res, string) result =
      fun l l' ->
    ...
    method longident_loc : longident_loc -> longident_loc -> ('res, string) result =
    ...
    method direction_flag : direction_flag -> direction_flag -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method override_flag : override_flag -> override_flag -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method str_loc_lst : string loc list -> string loc list -> ('res, string) result =
    ...
    method core_type : core_type -> core_type -> ('res, string) result =
      fun { ptyp_desc; ptyp_loc; ptyp_loc_stack; ptyp_attributes }
        ...
        let ptyp_loc_stack = self#location_stack ptyp_loc_stack ptyp_loc_stack' in
        let ptyp_attributes = self#attributes ptyp_attributes ptyp_attributes' in
        self#record
          "core_type"
          [ "ptyp_desc", ptyp_desc
          ; "ptyp_loc", ptyp_loc
    ...
    method core_type_desc : core_type_desc -> core_type_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
      ...
      fun (a, b) (a', b') ->
        ...
        let b =
          self#list
            ...
            b
        in
        self#tuple [ "longident_loc", a; "(longident_loc * core_type) list", b b' ]
    ...
    method row_field_desc : row_field_desc -> row_field_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method pattern : pattern -> pattern -> ('res, string) result =
      fun { ppat_desc; ppat_loc; ppat_loc_stack; ppat_attributes }
        ...
        let ppat_loc_stack = self#location_stack ppat_loc_stack ppat_loc_stack' in
        let ppat_attributes = self#attributes ppat_attributes ppat_attributes' in
        self#record
          "pattern"
          [ "ppat_desc", ppat_desc
          ; "ppat_loc", ppat_loc
    ...
    method pattern_desc : pattern_desc -> pattern_desc -> ('res, string) result =
      fun x x' ->
        ...
        | Ppat_tuple [ exp1 ], ppat_desc' ->
          self#pattern_desc x (Ppat_tuple [ { exp1 with ppat_desc = ppat_desc' } ])
    ...
    method expression : expression -> expression -> ('res, string) result =
      fun { pexp_desc; pexp_loc; pexp_loc_stack; pexp_attributes }
        ...
        let pexp_loc_stack = self#location_stack pexp_loc_stack pexp_loc_stack' in
        let pexp_attributes = self#attributes pexp_attributes pexp_attributes' in
        self#record
          "expression"
          [ "pexp_desc", pexp_desc
          ; "pexp_loc", pexp_loc
    ...
    method expression_desc : expression_desc -> expression_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
        ...
        | Pexp_record (a, b), Pexp_record (a', b') ->
          ...
          self#constr
            "Pexp_record"
            [ "(longident_loc * expression) list", a a'; "expression option", b ]
        ...
        | Pexp_override a, Pexp_override a' ->
          let a =
            self#list
              ...
              a
          in
          self#constr "Pexp_override" [ "(label loc * expression) list", a a' ]
        | Pexp_letmodule (a, b, c), Pexp_letmodule (a', b', c') ->
          ...
          self#constr
            "Pexp_letmodule"
            [ "label option loc", a a'; "module_expr", b; "expression", c ]
        ...
        | Pexp_unreachable, Pexp_unreachable -> self#constr "Pexp_unreachable" []
        (*BEGIN SPECIAL CASES*)
        ...
        | ( Pexp_apply (({ pexp_desc = Pexp_newtype _; _ } as exp1), al_exp_list)
          , Pexp_newtype _ ) ->
          self#expression_desc x (Pexp_apply ({ exp1 with pexp_desc = x' }, al_exp_list))
        (*Unknown for now.*)
        | Pexp_newtype (a, b), Pexp_apply ({ pexp_desc = Pexp_newtype (a', b'); _ }, _) ->
          let a = self#loc self#string a a' in
          let b = self#expression b b' in
          self#constr "Pexp_newtype" [ "label loc", a; "expression", b ]
        ...
        | ( Pexp_constraint (a, b)
          ...
          let b = self#core_type b b' in
          self#constr "Pexp_constraint" [ "expression", a; "core_type", b ]
        (*Caused by : [let open! ((Ppx_deriving_yojson_runtime)[@ocaml.warning "-A"]) in ... ] *)
        | Pexp_open (a, b), Pexp_constraint ({ pexp_desc = Pexp_open (a', b'); _ }, _) ->
          let a = self#open_declaration a a' in
          let b = self#expression b b' in
          self#constr "Pexp_open" [ "open_declaration", a; "expression", b ]
        (* Caused by : [(let open! ((Ppx_deriving_runtime)[@ocaml.warning "-A"])...] *)
        | Pexp_let (a, b, c), Pexp_constraint ({ pexp_desc = Pexp_let (a', b', c'); _ }, _)
          ->
          let a = self#rec_flag a a' in
          let b = self#list self#value_binding b b' in
          let c = self#expression c c' in
          ...
          let normalized_newtypes =
            Pexp_newtype
              ...
              , { ntrec1 with
                  pexp_desc =
                    Pexp_newtype
                      (lloc2, { ntrec2 with pexp_desc = Pexp_newtype (lloc3, e1) })
                } )
          in
          let normalized_apply =
            Pexp_apply ({ e1 with pexp_desc = normalized_newtypes }, arg_lablel_e_list)
          in
        ...
        | Pexp_tuple [ exp1 ], pexp_desc' ->
          self#expression_desc x (Pexp_tuple [ { exp1 with pexp_desc = pexp_desc' } ])
    ...
    method value_description
      ...
      fun { pval_name; pval_type; pval_prim; pval_attributes; pval_loc }
        ...
        let pval_attributes = self#attributes pval_attributes pval_attributes' in
    ...
    method type_declaration
      ...
      fun { ptype_name
            ...
            (fun (a, b) (a', b') ->
               ...
               let b =
                 (fun (a, b) (a', b') ->
                   ...
                   b
               in
               self#tuple [ "core_type", a; "(variance * injectivity)", b b' ])
            ptype_params
            ptype_params'
        in
        let ptype_cstrs =
        ...
        let ptype_manifest = self#option self#core_type ptype_manifest ptype_manifest' in
        let ptype_attributes = self#attributes ptype_attributes ptype_attributes' in
    ...
    method constructor_declaration
      : constructor_declaration -> constructor_declaration -> ('res, string) result =
    ...
    method type_extension : type_extension -> type_extension -> ('res, string) result =
      fun { ptyext_path
          ; ptyext_params
          ; ptyext_constructors
          ; ptyext_private
        ...
        let ptyext_constructors =
          self#list self#extension_constructor ptyext_constructors ptyext_constructors'
        in
        ...
        let ptyext_attributes = self#attributes ptyext_attributes ptyext_attributes' in
        self#record
          "type_extension"
          [ "ptyext_path", ptyext_path
          ; "ptyext_params", ptyext_params
    ...
    method extension_constructor
      ...
      fun { pext_name; pext_kind; pext_loc; pext_attributes }
        ...
        let pext_attributes = self#attributes pext_attributes pext_attributes' in
        self#record
    ...
    method type_exception : type_exception -> type_exception -> ('res, string) result =
      fun { ptyexn_constructor; ptyexn_loc; ptyexn_attributes }
        ...
        let ptyexn_attributes = self#attributes ptyexn_attributes ptyexn_attributes' in
        self#record
          "type_exception"
          [ "ptyexn_constructor", ptyexn_constructor
          ; "ptyexn_loc", ptyexn_loc
    ...
    method extension_constructor_kind
      : extension_constructor_kind -> extension_constructor_kind -> ('res, string) result
        =
      fun x x' ->
        match x, x' with
    ...
    method class_type : class_type -> class_type -> ('res, string) result =
      fun { pcty_desc; pcty_loc; pcty_attributes }
        ...
        let pcty_attributes = self#attributes pcty_attributes pcty_attributes' in
        self#record
          "class_type"
          [ "pcty_desc", pcty_desc
          ; "pcty_loc", pcty_loc
    ...
    method class_type_desc : class_type_desc -> class_type_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method class_signature : class_signature -> class_signature -> ('res, string) result =
      fun { pcsig_self; pcsig_fields }
        ...
        let pcsig_fields = self#list self#class_type_field pcsig_fields pcsig_fields' in
        self#record
          "class_signature"
          [ "pcsig_self", pcsig_self; "pcsig_fields", pcsig_fields ]
    ...
    method class_type_field
      ...
      fun { pctf_desc; pctf_loc; pctf_attributes }
        ...
        let pctf_attributes = self#attributes pctf_attributes pctf_attributes' in
        self#record
          "class_type_field"
          [ "pctf_desc", pctf_desc
          ; "pctf_loc", pctf_loc
    ...
    method class_type_declaration
      : class_type_declaration -> class_type_declaration -> ('res, string) result =
      self#class_infos self#class_type
    ...
    method class_expr_desc : class_expr_desc -> class_expr_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method class_structure : class_structure -> class_structure -> ('res, string) result =
      fun { pcstr_self; pcstr_fields }
        ...
        let pcstr_fields = self#list self#class_field pcstr_fields pcstr_fields' in
        self#record
          "class_structure"
          [ "pcstr_self", pcstr_self; "pcstr_fields", pcstr_fields ]
        ...
        | Pcf_val a, Pcf_val a' ->
          let a =
            (fun (a, b, c) (a', b', c') ->
              ...
              a
          in
          self#constr "Pcf_val" [ "(label loc * mutable_flag * class_field_kind)", a a' ]
    ...
    method module_type : module_type -> module_type -> ('res, string) result =
      fun { pmty_desc; pmty_loc; pmty_attributes }
        ...
        let pmty_attributes = self#attributes pmty_attributes pmty_attributes' in
        self#record
          "module_type"
          [ "pmty_desc", pmty_desc
          ; "pmty_loc", pmty_loc
    ...
    method signature_item : signature_item -> signature_item -> ('res, string) result =
      fun { psig_desc; psig_loc } { psig_desc = psig_desc'; psig_loc = psig_loc' } ->
    ...
    method module_type_declaration
      : module_type_declaration -> module_type_declaration -> ('res, string) result =
      fun { pmtd_name; pmtd_type; pmtd_attributes; pmtd_loc }
        ...
        let pmtd_attributes = self#attributes pmtd_attributes pmtd_attributes' in
    ...
    method open_infos
      ...
      fun _a
        ...
        let popen_attributes = self#attributes popen_attributes popen_attributes' in
        self#record
          "open_infos"
          [ "popen_expr", popen_expr
          ; "popen_override", popen_override
    ...
    method include_infos
      ...
      fun _a
        ...
        let pincl_attributes = self#attributes pincl_attributes pincl_attributes' in
        self#record
          "include_infos"
          [ "pincl_mod", pincl_mod
          ; "pincl_loc", pincl_loc
    ...
    method with_constraint : with_constraint -> with_constraint -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method module_expr : module_expr -> module_expr -> ('res, string) result =
      fun { pmod_desc; pmod_loc; pmod_attributes }
        ...
        let pmod_attributes = self#attributes pmod_attributes pmod_attributes' in
        self#record
          "module_expr"
          [ "pmod_desc", pmod_desc
          ; "pmod_loc", pmod_loc
    ...
    method structure_item : structure_item -> structure_item -> ('res, string) result =
      fun { pstr_desc; pstr_loc } { pstr_desc = pstr_desc'; pstr_loc = pstr_loc' } ->
    ...
    method toplevel_phrase : toplevel_phrase -> toplevel_phrase -> ('res, string) result =
      fun x x' ->
        match x, x' with
    ...
    method directive_argument_desc
      : directive_argument_desc -> directive_argument_desc -> ('res, string) result =
      fun x x' ->
        match x, x' with
